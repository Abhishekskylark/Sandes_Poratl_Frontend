...
import { faCamera, faMessage, faXmark, faPlus, faHouse, faCircleInfo, faPenToSquare, faEnvelope, faTrash, faMagnifyingGlass, faGear, faUsersLine, faRightFromBracket } from '@fortawesome/free-solid-svg-icons';
...
function UnverifiedMembersDash({ drawerWidth, collapsedDrawerWidth, desktopOpen }) {
    ...
    return (
        ...
        >
            ...
            <Drawer anchor="top" open={open} onClose={toggleDrawer(false)}>
                ...
                >
                    <Typography variant="h4" textAlign="center" color='#003566' fontWeight="700" gutterBottom>
                        Send Message
                    </Typography>
                    <div className="row">
                        <div className="col-md-6 mt-3">
...
"
            ...
            <Drawer anchor="top" open={openRole} onClose={toggleDrawerRole(false)}>
                ...
                >
                    ...
                    <button type="submit" className="btn btn-info mt-4 mr-2"> <FontAwesomeIcon icon={faPlus} color='green' /> Assign ROLE_OU_ADMIN</button>
                    <button type="submit" className="btn btn-info mt-4"> <FontAwesomeIcon icon={faPlus} color='green' /> Assign ROLE_OU_ADMIN</button>
...
export default UnverifiedMembersDash;

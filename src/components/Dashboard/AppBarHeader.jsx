...
//             <FontAwesomeIcon icon={faUserTie} className="mr-2" style={{ fontSize: "20px" }} />  Sign in as {role} for POC
//           </MenuItem>
//           <MenuItem component={Link} to="/LoginAdmin" onClick={handleMenuClose}>
//             <FontAwesomeIcon icon={faUserTie} className="mr-2" style={{ fontSize: "20px" }} />  Sign in as {role} for POC
//           </MenuItem>
//           <MenuItem component={Link} to="/LoginAdmin" onClick={handleMenuClose}>
//             <FontAwesomeIcon icon={faBuilding} className="mr-2" style={{ fontSize: "20px" }} /> Signed in as {role} for POC
//           </MenuItem>
//           <MenuItem component={Link} to="/LoginAdmin" onClick={handleMenuClose}>
//             <FontAwesomeIcon icon={faSitemap} className="mr-2" style={{ fontSize: "20px" }} /> Sign in as {role} for POC
//           </MenuItem>
//           <MenuItem component={Link} to="/LoginAdmin" onClick={handleMenuClose}>
...
const AppBarHeader = ({ handleDrawerToggle }) => {
  ...
  // console.log("rolerolerole", AllRoles);
